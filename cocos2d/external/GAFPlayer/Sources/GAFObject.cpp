...
void GAFObject::setLastFramePlayedDelegate(GAFLastFramePlayedDelegate_t delegate)
{
    m_lastFramePlayedDelegate = delegate;
}
...
void GAFObject::step()
{
    ...
    auto bIsCurrentFrameLastInSequence = isCurrentFrameLastInSequence();
    if (bIsCurrentFrameLastInSequence) {
        if (m_isLooped) {
    ...
    if (bIsCurrentFrameLastInSequence && m_lastFramePlayedDelegate) {
        m_lastFramePlayedDelegate(this);
    }
}
