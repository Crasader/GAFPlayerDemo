...
private:
    ...
    GAFFramePlayedDelegate_t                m_framePlayedDelegate = nullptr;
    GAFLastFramePlayedDelegate_t            m_lastFramePlayedDelegate = nullptr;
...
public:
    ...
    void setLastFramePlayedDelegate(GAFLastFramePlayedDelegate_t delegate);
